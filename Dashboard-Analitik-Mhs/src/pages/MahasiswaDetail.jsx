// FRONTEND/src/pages/MahasiswaDetail.jsx
import { useState, useEffect } from 'react';
import { useParams, useNavigate } from 'react-router-dom';
import { useAuth } from '../context/AuthContext';
import { useStudentAnalytics } from '../hooks/useStudentAnalytics';
import { User, BookOpen, GraduationCap, ArrowLeft, CheckCircle, Clock, AlertTriangle, Upload as UploadIcon, FileText, Users } from 'lucide-react';
...
const MahasiswaDetail = () => {
  ...
  // Cek jika analytics null atau error karena data tidak ditemukan
  useEffect(() => {
  ...
  // ... Rest of your component (sama seperti sebelumnya)
  ...
  return (
    <div className="space-y-6 animate-fade-in font-sans pb-10">
      ...
      {/* Profil Header - Sama seperti sebelumnya */}
      ...
      {/* TAB: RIWAYAT NILAI - Sama seperti sebelumnya */}
      ...
      {/* TAB: STATUS AKHIR - Sama seperti sebelumnya */}
